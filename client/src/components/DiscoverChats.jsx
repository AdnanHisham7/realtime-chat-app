...
const DiscoverChats = ({ handleCancel, onChatSelect  }) => {
  ...
  return (
    <div className="w-full mx-auto rounded-lg border dark:border-gray-800 bg-white dark:bg-customGray h-full flex flex-col min-h-screen lg:min-h-0">

      {/* Header */}
      <div className="flex items-center justify-between px-4 pt-4">
        <h1 className="text-lg font-bold text-gray-800 dark:text-gray-200">Discover People</h1>
        <button
